...
namespace Markov_laba_2.Controllers
{
    public class CouriersController : Controller
    {
        ...
        public CouriersController(Markov_laba_2Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Login,Password,Name,Surname")] Courier courier)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Login,Password,Name,Surname")] Courier courier)
        {
            if (id != courier.Id)
            {
                return NotFound();
